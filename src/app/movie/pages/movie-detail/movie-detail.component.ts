...
export class MovieDetailComponent implements OnInit {
  @ViewChild("backdropsGallery", { static: true })
  backdropGallery: FullScreenGalleryComponent;
  @ViewChild("postersGallery", { static: true })
  postersGallery: FullScreenGalleryComponent;
